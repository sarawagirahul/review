          ...
          <form className="flex flex-col gap-6 p-8 rounded-lg border border-hairline bg-surface-soft">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
                ...
                <input type="text" className="bg-white border border-hairline rounded-md p-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/10" placeholder="Jane Doe" />
              </div>
              <div className="flex flex-col gap-2">
                <label className="text-xs font-bold uppercase tracking-wider text-ink">Email</label>
                <input type="email" className="bg-white border border-hairline rounded-md p-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/10" placeholder="jane@example.com" />
              </div>
            </div>
            <div className="flex flex-col gap-2">
              <label className="text-xs font-bold uppercase tracking-wider text-ink">Message</label>
              <textarea rows={4} className="bg-white border border-hairline rounded-md p-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/10" placeholder="How can we help?" />
            </div>
